...
# Datos de los computadores remotos (estos valores son solo de ejemplo)
remote_client_data = {
    "ID": "RemoteClient",
    "CPUUsage": 42.0,
    "RAMUsage": 58.7,
...
# Identificador para el servidor central
own_data = {
    "ID": "ServerCentral",
    "CPUUsage": 0.0,
    "RAMUsage": 0.0,
...
SERVER_IP = "157.253.192.187"  # Dirección IP del servidor (0.0.0.0 escucha en todas las interfaces)
...
def handle_client(client_socket):
    ...
    while True:
        ...
        own_data["CPUUsage"] = own_cpu_usage
        own_data["RAMUsage"] = own_ram_usage
        own_data["DiskUsage"] = own_disk_usage
